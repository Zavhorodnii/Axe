<?php
/*
	Template Name: Понравившиеся товары
...
<!--                <div class="products__wrap">-->
                        ...
                        if (count($cookie) > 1) {
                                ...
                                if(strlen(trim($product)) > 0){
                                    ...
                                    <div class="__item card__item-price_btn js_loader_control">
                                        <div class="like-hit__row">
                                            <a href="#" class="like js_can_remove js_click_like <?php echo in_array($product, $cookie) ? 'v_active_like' : '' ?>" data-id_product="<?php echo $product ?>"></a>
                            ...
                            ?>
                            <div class="page-404__inner v_page_like_product v_product_wrap">
                                <h3 class="page-404__title">Нету понравившихся товаров</h3>
